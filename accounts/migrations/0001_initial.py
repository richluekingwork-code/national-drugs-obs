    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('system_admin', 'System Admin'), ('moj_head', 'MOJ Head'), ('ldea_head', 'LDEA Head'), ('ldea_ops', 'LDEA Head of OPs'), ('officers', 'Officers'), ('ldea_head_of_it', 'LDEA Head of IT'), ('moh_head', 'MOH Head'), ('mog_head', 'MOG Head'), ('moys_head', 'MOYS Head')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='LDEA_profile', to=settings.AUTH_USER_MODEL)),
